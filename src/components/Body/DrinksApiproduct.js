...
function DrinksApiproduct(props) {
...
const VegpoductsApi = () => {
        fetch(`${window.sbapi}/api/Product/ProductEcomData?DepartmentCode=0008&GroupCode=&SubGroupCode=&FromIndex=1&ToIndex=7&BusinessId=0000000001`)
            .then(res => res.json())
            .then(json => {
...
export default DrinksApiproduct;
