...
const VegpoductsApi = () => {
        fetch(`${window.sbapi}/api/Product/ProductEcomData?DepartmentCode=0004&GroupCode=&SubGroupCode=&FromIndex=1&ToIndex=7&BusinessId=0000000001`)
            .then(res => res.json())
            .then(json => {
